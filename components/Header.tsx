      ...
      <div className="container mx-auto px-6 lg:px-16">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex items-center gap-10">
            ...
            <Link
              href="/epic"
              className="text-xs tracking-[0.15em] uppercase hover:opacity-60 transition-opacity relative"
            >
              Epic
              <span className="absolute -bottom-1 left-0 right-0 h-[2px] bg-[#8B2635]" />
            </Link>
            <Link
              href="/journeys"
              className="text-xs tracking-[0.15em] uppercase hover:opacity-60 transition-opacity"
        ...
        {/* Mobile Navigation */}
        {mobileMenuOpen && (
          <nav className="md:hidden pb-8 pt-4 space-y-1 border-t border-border">
            <Link
              href="/stories"
              className="block text-sm tracking-[0.15em] uppercase py-3"
            ...
            <Link
              href="/epic"
              className="block text-sm tracking-[0.15em] uppercase py-3 relative w-fit"
              onClick={() => setMobileMenuOpen(false)}
            >
              Epic
            ...
            <div className="pt-4">
              <Link
                href="/plan-your-trip"
                className="inline-block text-sm tracking-[0.15em] uppercase border border-foreground px-6 py-3"
                onClick={() => setMobileMenuOpen(false)}
              >
                Plan Your Trip
              </Link>
