  ...
  columns: [
    ...
    },
    {
      ...
      links: [
        ...
        { order: 3, label: "Stories", href: "/stories", type: "link" },
        { order: 4, label: "Contact Us", href: "/contact", type: "link" },
      ],
    },
    {
      number: 3,
    ...
    },
    {
      ...
      links: [
        ...
        { order: 2, label: "Visa Information", href: "/visa-info", type: "link" },
    ...
    <footer>
                      ...
                      {socialLinks.map((link, linkIndex) => {
                        ...
                        return link.href ? (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-white/80 hover:text-white transition-colors p-2 -m-2 tap-target"
      ...
      <section className="py-6 bg-foreground border-t border-white/10">
        <div className="container mx-auto px-6 lg:px-16">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 mb-4">
            {footerData.legal.map((link, index) => (
              <Link
                key={index}
                href={link.href}
                className="text-xs text-white/50 hover:text-white/80 transition-colors py-2 px-2"
              >
                {link.label}
              </Link>
            ))}
            ...
            <button className="text-xs text-white/50 hover:text-white/80 transition-colors flex items-center gap-1 py-2 px-2">
            ...
            {showCurrency && (
              <button className="text-xs text-white/50 hover:text-white/80 transition-colors py-2 px-2">
                € EUR
              </button>
            )}
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-1 gap-y-1 mt-4 pt-4 border-t border-white/10">
            {SLOW_WORLD_COUNTRIES.map((country, index) => {
              ...
              return (
                <span key={country.id} className="flex items-center">
                  {isCurrent ? (
                    <span className="text-xs text-white/60 underline underline-offset-4 py-2 px-2">
                      {country.name}
                    </span>
                  ) : (
                    <a
